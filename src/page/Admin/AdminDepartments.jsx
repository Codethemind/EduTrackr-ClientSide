...
const AdminDepartments = () => {
  const [departments, setDepartments] = useState([
    { id: 1, name: 'Computer Science', code: 'CS', headOfDepartment: 'Dr. Smith', courses: 12, students: 240 },
    { id: 2, name: 'Electrical Engineering', code: 'EE', headOfDepartment: 'Dr. Johnson', courses: 10, students: 180 },
    { id: 3, name: 'Mechanical Engineering', code: 'ME', headOfDepartment: 'Dr. Brown', courses: 8, students: 150 },
  ]);
        ...
        <header className="bg-white shadow-sm">
          <div className="flex items-center justify-between px-8 py-6">
            <div>
              ...
              <p className="mt-1 text-sm text-gray-600">Manage and monitor all departments</p>
            </div>
                ...
                {filteredDepartments.map((department) => (
                  <tr key={department.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-center">
                      <div className="text-sm text-gray-900">{department.courses}</div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap text-center">
                      <div className="text-sm text-gray-900">{department.students}</div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap text-center">
