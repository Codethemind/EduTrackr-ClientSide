  ...
  useEffect(() => {
    const fetchStudentDetails = async () => {
      ...
      try {
        ...
        // Fetch all assignments and filter by student's submissions
        try {
          ...
          // Process assignments data to include student's submission
          const processedAssignments = allAssignments.map(assignment => {
            const studentSubmission = assignment.submissions?.find(
              submission => submission.studentId === id
            );
            ...
            return {
              ...
              teacher: assignment.teacherId?.name || 'N/A',
